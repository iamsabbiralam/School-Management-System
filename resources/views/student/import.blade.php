...
@section('page_title', 'Import Student')
@section('content')
                ...
                <div class="flex flex-wrap">
                    <div class="w-full my-6 pr-0 lg:pr-2">
                        <p class="text-xl pb-6 flex items-center">
                            <i class="fas fa-list mr-3"></i> Import Student
                        </p>
                        <div class="content-center leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl" action="{{ route('imports.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="">
